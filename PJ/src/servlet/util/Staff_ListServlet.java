...
@WebServlet(name = "Staff_ListServlet", value = "/paging")
public class Staff_ListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(session.getAttribute("result") != null){
            list = (List<Object>) session.getAttribute("result");
        }
        //页面当前页
        int page=0;
        //得到传过来的当前页
        ...
        paging.setPagesize(6);//一个页面的数据多少条
        ...
        session.setAttribute("list", list_page);
